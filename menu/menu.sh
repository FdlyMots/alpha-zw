...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/FdlyMots/set-ip/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/FdlyMots/set-ip/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/FdlyMots/set-ip/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/FdlyMots/set-ip/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "${BICyan} │${NC}   ${BICyan}[${BIWhite}05${BICyan}] SETTING  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}  ""   ${BICyan}[${BIWhite}10${BICyan}] SET REBOOT  ${BICyan}[${BIYellow}Menu${BICyan}]${NC}" "${BICyan}  │${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "         ${BICyan}┌─────────────────────────────────────┐${NC}"
